...
public class PrintEx03 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Date date = new Date();
		System.out.println(date); // Thu Feb 17 13:05:02 KST 2022
		...
		System.out.println(time);				// 1645072768783
		System.out.println(sdf1.format(time));	// 2022-02-17
		System.out.println(sdf2.format(time));	// 20220217
		System.out.println(sdf3.format(time));	// 2022년 02월 17일 목요일 오후 01시 40분 55초
